...
def LD_GPR0():
    ...
    GPR0_num = GPR0.get()
    CPU.__init__.GR(0).set(GPR0_num)
    print(GPR0_num) #Setting the Register in memory
...
def LD_GPR1():
    ...
    GPR1_num = GPR1.get()
    CPU.__init__.GR(1).set(GPR1_num)
    print(GPR1_num)
    return
def LD_GPR2():
    GPR2.delete(0,END)
    ...
    GPR2_num = GPR2.get()
    CPU.__init__.GR(2).set(GPR2_num)
    print(GPR2_num)    
    return
def LD_GPR3():
    GPR3.delete(0,END)
    ...
    GPR3_num=GPR3.get()
    CPU.__init__.GR(3).set(GPR3_num)
    print(GPR3_num)
    return
def LD_IXR1():
    IXR1.delete(0,END)
    ...
    IXR1_num = IXR1.get()
    CPU.__init__.IndexRegister(0).set(IXR1_num)
    print(IXR1_num)
    return
def LD_IXR2():
    IXR2.delete(0,END)
    ...
    IXR2_num = IXR2.get()
    CPU.__init__.IndexRegister(1).set(IXR2_num)
    print(IXR2_num)    
    return
def LD_IXR3():
    IXR3.delete(0,END)
    ...
    IXR3_num = IXR3.get()
    CPU.__init__.IndexRegister(2).set(IXR3_num)
    print(IXR3_num)    
    return
def LD_PC():
    PC.delete(0,END)
    PC.insert(0,str(num15)+str(num14)+str(num13)+str(num12)+str(num11)+str(num10)+str(num9)+str(num8)+str(num7)+str(num6)+str(num5)+str(num4)+str(num3)+str(num2)+str(num1)+str(num0))
    PC_num = PC.get()
    return
def LD_MAR():
    MAR.delete(0,END)
    MAR.insert(0,str(num15)+str(num14)+str(num13)+str(num12)+str(num11)+str(num10)+str(num9)+str(num8)+str(num7)+str(num6)+str(num5)+str(num4)+str(num3)+str(num2)+str(num1)+str(num0))
    MAR_num=MAR.get()
    return
def LD_MBR():
    MBR.delete(0,END)
...
def programLoad():
    fileName = filedialog.askopenfilename(title="Select File", initialdir=".", filetypes=(("txt files", "*.txt"), ("all files", "*.")))
...
Load = Button(frameoperation, text="Load", command=programLoad)
Init = Button(frameoperation, text="Init")
SS = Button(framerun, text="SS")
